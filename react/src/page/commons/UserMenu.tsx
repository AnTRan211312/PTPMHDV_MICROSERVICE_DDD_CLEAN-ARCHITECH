...
import { logout } from "@/features/slices/authThunk.ts";
...
const UserMenu = ({ blackTheme }: UserMenuProps) => {
    ...
    // Derive avatar version from user.updatedAt (use 0 as stable fallback)
            ...
            >
                ...
                <DropdownMenuItem>
                    ...
                    >
                        ...
                        <div className="min-w-0">
                            <p className="font-medium">Lịch sử đánh giá</p>
                        </div>
                    </Link>
                </DropdownMenuItem>
                ...
                <HasPermission perm={"GET /api/orders/admin/all"}>
                    <DropdownMenuItem>
                        <Link
                            to={"/admin"}
                            className="flex cursor-pointer items-center gap-3 rounded-lg"
