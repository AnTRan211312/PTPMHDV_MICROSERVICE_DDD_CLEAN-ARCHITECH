...
interface PermissionFormProps {
    ...
    onSubmit: (data: PermissionRequest, id?: number) => void;
...
export function PermissionForm({
    ...
    const handleOpenChange = (newOpen: boolean) => {
        if (newOpen) {
            ...
            if (initialData) {
                ...
                // Reset form only when opening for create (not edit)
                setFormData({ name: "", apiPath: "", method: "", module: "" });
            }
        } else {
            // When closing dialog, don't reset form data here
            // Let parent component handle cleanup
        }
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        // After update, user can manually close the dialog
    };
